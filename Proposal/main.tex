...
\section{Parts of the language and what they do}
    \begin{itemize}
        \item Data types: Integers (int), floating point numbers (float), sinle and multidimensional arrays, matrices (up to 4x4) (matrix), strings (string) -- for file I/O and writing
